...
(uint32_t) &SW_INT_1_isr, /* Vector #   1 Software settable flag 1 INTC (Software) */
...
(uint32_t) &PIT0_isr, /* Vector # 226 Periodic Interrupt Timer (PIT_0) channel 0 PIT_0 */
(uint32_t) &PIT1_isr, /* Vector # 227 Periodic Interrupt Timer (PIT_0) channel 1 PIT_0 */
(uint32_t) &PIT2_isr, /* Vector # 228 Periodic Interrupt Timer (PIT_0) channel 2 PIT_0 */
